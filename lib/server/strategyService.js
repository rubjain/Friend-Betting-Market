...
function demoStore() {
  if (!globalThis.__friendMarketStrategies) {
    globalThis.__friendMarketStrategies = [];
  }
  return globalThis.__friendMarketStrategies;
}

function demoExecStore() {
  if (!globalThis.__friendMarketStrategyExecutions) {
    globalThis.__friendMarketStrategyExecutions = [];
  }
  return globalThis.__friendMarketStrategyExecutions;
}
