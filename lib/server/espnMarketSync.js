 ...
 */
export function moneylineToPrices(ml) {
 ...
 */
export function resultFromFinalScore(game) {
...
export async function buildMarketData(game) {
...
export async function syncEspnMarketsToDb(client) {
  ...
  for (const game of games) {
    ...
    if (isTbdName(game.homeTeam) || isTbdName(game.awayTeam)) {
...
export function getEspnSyncStatus() {
  return {
