...
import { recordStrategySignalFromBet } from "../server/copyTradingService.js";
...
export async function runStrategyOnce({ strategy, userId }) {
  ...
  const actionDedupe =
    globalThis.__agoraStrategyActionDedupe ?? (globalThis.__agoraStrategyActionDedupe = new Map());
