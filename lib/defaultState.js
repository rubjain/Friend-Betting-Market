...
export const STORAGE_KEY = "agora-state";
...
export const defaultState = {
  ...
  mobileNavOpen: false,
  theme: "light",
  eventNotifications: [], // persisted event-driven notifications (order filled, bet settled, etc.)
  auth: {
    authenticated: false,
  ...
  currentUser: {
    ...
    settings: {
      ...
      locationVerificationStatus: "placeholder",
      ageVerificationStatus: "placeholder",
      sanctionsVerificationStatus: "placeholder",
      selfExcludedUntil: "",
  ...
  liveGames: [
    {
      ...
      homeTeam: "Raptors",
      homeAbbr: "TOR",
      homeTeamColor: "#CE1141",
      awayTeam: "Cavaliers",
      awayAbbr: "CLE",
      awayTeamColor: "#860038",
      homeScore: 88,
      awayScore: 91,
    ...
    },
    {
      ...
      clock: "7:10 PM ET",
      homeTeam: "Mets",
      homeTeamColor: "#002D72",
      awayTeam: "Braves",
      awayTeamColor: "#CE1141",
      homeScore: 0,
      awayScore: 0,
