...
export const defaultState = {
  ...
  markets: [
    ...
    withResolutionDefaults({
      ...
      title: "Will the Cavaliers beat the Raptors tonight? (May 3)",
      category: "NBA",
      volume: 92400,
      endDate: "2026-05-04",
      yesPrice: 0.52,
      ...
      resolutionRule:
        "Resolves YES if the Cleveland Cavaliers defeat the Toronto Raptors in this scheduled regular-season game once final. Resolves NO if the Raptors win or the game is voided under league rules.",
      evidenceLinks: [
        {
      ...
      description:
        "Single-game NBA market tied to the live Cavaliers at Raptors broadcast feed. Prices react to in-game updates in demo mode.",
      recentActivity: [
