...
export const defaultState = {
  ...
  markets: [
    ...
    withResolutionDefaults({
      id: "market_15",
      title: "Will Apple announce new AR hardware before October?",
      category: "Tech",
      volume: 20180,
      endDate: "2026-09-30",
      yesPrice: 0.37,
      noPrice: 0.63,
      algorithm: {
        model: "Product-event tracker",
        dataFeeds: ["Apple Newsroom", "Event page", "Store availability"],
        refreshCadence: "Daily source sweep",
      },
      resolutionRule:
        "Resolves YES if Apple officially announces new augmented-reality hardware before October 1, 2026. Software-only updates do not count.",
      evidenceLinks: [
        {
      ...
      friendGroup: [],
      description:
        "Tech launch market focused on official product announcement language and public hardware availability.",
      recentActivity: [
    ...
    withResolutionDefaults({
      id: "market_16",
      title: "Will NYC get measurable rain on Memorial Day?",
      category: "Weather",
      volume: 5400,
      endDate: "2026-05-25",
      yesPrice: 0.46,
      noPrice: 0.54,
      algorithm: {
        model: "Forecast blend + station observation",
        dataFeeds: ["National Weather Service", "Central Park station data", "Hourly forecast"],
        refreshCadence: "Every forecast update",
      },
      resolutionRule:
        "Resolves YES if the official Central Park station records at least 0.01 inches of precipitation on Memorial Day 2026. Resolves NO otherwise.",
      evidenceLinks: [
        {
      ...
      friendGroup: [],
      description:
        "Weather market with a named station, measurable-rain threshold, and official daily observation source.",
      recentActivity: [
    ...
    withResolutionDefaults({
      id: "market_17",
      title: "Will the S&P 500 close June at a new all-time high?",
      category: "Finance",
      volume: 28750,
      endDate: "2026-06-30",
      yesPrice: 0.43,
      noPrice: 0.57,
      algorithm: {
        model: "Index close + momentum tracker",
        dataFeeds: ["Official index close", "Exchange calendar", "Market holiday schedule"],
        refreshCadence: "Every market close",
      },
      resolutionRule:
        "Resolves YES if the S&P 500's official closing level on June 30, 2026 is higher than every prior official close. Resolves NO otherwise.",
      evidenceLinks: [
        {
    ...
    withResolutionDefaults({
      id: "market_18",
      title: "Will a streaming comedy win the top Emmy comedy award?",
      category: "Culture",
      volume: 12880,
      endDate: "2026-09-20",
      yesPrice: 0.55,
      noPrice: 0.45,
      algorithm: {
        model: "Awards shortlist + critic momentum",
        dataFeeds: ["Television Academy", "Nomination list", "Awards result page"],
        refreshCadence: "Daily after nominations",
      },
      resolutionRule:
        "Resolves YES if the Primetime Emmy Award for Outstanding Comedy Series is won by a show primarily distributed by a streaming service. Resolves NO otherwise.",
      evidenceLinks: [
        {
          label: "Television Academy awards",
          url: "https://www.emmys.com/awards",
          sourceType: "official",
        },
      ],
      eligibleForBonus: true,
      ...
      friendGroup: [],
      description:
        "Awards market with an official winner source and a simple streaming-distribution classification rule.",
      recentActivity: [
